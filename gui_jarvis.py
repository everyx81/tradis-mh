    ...
    def _show_startup_guide(self):
        ...
        pages = [
            # === 소개 ===
            {
                "title": "TRADIS MH 소개",
                "content": (
                    "수입/수출 통관 서류를 AI로 자동 분석하고\n"
                    "BL별로 분류·병합하는 프로그램입니다.\n\n"
                    "전체 흐름:\n"
                    "PDF 투입 → AI 분석 → 이름 변경\n"
                    "→ BL별 카드 매칭 → 합치기 / 폴더 정리\n"
                    "→ 선적서류 추가 → 서버 이동"
            ...
            # === 초기 설정 ===
            {
                "title": "① API 키 설정",
                "content": (
                    "AI 문서 분석에 필요한 Gemini API 키입니다.\n"
                    "관리자에게 발급받아 입력하세요.\n\n"
                    "설정 위치:\n"
                    "좌측 사이드바 하단 [AI Connected] 칩의\n"
                    "톱니바퀴 버튼 클릭"
                ),
            },
            {
                ...
                "content": (
                    ...
                    "설정 위치:\n"
                    "좌측 사이드바 하단의 폴더 경로 칩 클릭\n"
                    "또는 원형 토글 시작 전에 경로 지정"
                ),
            },
            {
                "title": "③ 서버 / 선적서류 경로",
                "content": (
                    ...
                    "• 수입 서버 경로: 수입 건 이동 대상\n"
                    "• 수출 서버 경로: 수출 건 이동 대상\n"
                    "• 선적서류 경로: 합치기 시 자동으로 추가될\n"
                    "  선적서류 검색 폴더"
                ),
            },
            # === 핵심 기능 — 필터링 / 월납업체 ===
            {
                "title": "④ 자동 이름 변경 제외 키워드  ★",
                "content": (
                    "파일명에 특정 키워드가 포함되면\n"
                    "AI 이름 변경을 건너뛸 수 있습니다.\n\n"
                    "사용 예:\n"
                    "• '월별납부' 키워드 추가\n"
                    "• → '회사_월별납부_4월.pdf' 등 건너뜀\n\n"
                    "시스템 내장 제외 (항상 제외):\n"
                    "• '10.' 접두사 (수동 보호 파일)\n"
                    "• '미분류_' 접두사\n"
                    "• 이미 이름 변경된 파일 (BL 포함)\n\n"
                    "설정 위치:\n"
                    "[설정] 탭 → '자동 이름 변경 제외 키워드'\n"
                    "  추가/삭제 가능 (Enter 또는 추가 버튼)"
                ),
            },
            {
                "title": "⑤ 월납업체 설정  ★",
            ...
            # === 핵심 기능 — 징수형태 ===
            {
                "title": "⑥ 징수형태 자동 인식",
                "content": (
                    "수입신고필증에서 AI가 징수형태를 추출하여\n"
                    "불필요한 서류는 '해당없음'으로 표시합니다.\n\n"
                    "징수형태 규칙:\n"
                    "• 11: 자진신고납부\n"
                    "  → 관/부가세 없으면 납부고지서 불필요\n"
                    "• 14: 수시부과\n"
                    ...
                    "• 43: 사후납부\n"
                    "  → 수입세금계산서 + 납부고지서 불필요\n\n"
                    "예외: 체크리스트의 항목을 직접 클릭하면\n"
                    "해당/해당없음 토글 가능 (BL별로 저장)"
                ),
            },
            # === 사용 방법 ===
            {
